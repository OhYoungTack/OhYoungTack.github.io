...
- 효과적으로 차원을 줄이면서 망을 깊게 할 수 있는 방법(Inxeption Module)을 개발하였습니다.
- GoogLeNet은 AlexNet에 비해 망의 깊이는 훨씬 깊은데 free parameter의 수는 1/12수준이고, 전체 연산량도 AlexNet에 비해 적다.
- GoogLeNet에선 vanishing gradient문제를 극복하기 위하여 Auxiliary classifier를 중간 2곳에 두었다.
...
<img src="/images/MLP.png" width="300" height="200">  
...
### Architexture
<img src="/images/VGGNet_1.png" width="300" height="200"> 
### Algorithm
